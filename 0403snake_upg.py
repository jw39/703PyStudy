...
def gameLoop(): #함수 gameLoop를 정의
    ...
    while not game_over:
     #게임이 끝나지 않았다면 반복
        ...
        pygame.draw.rect(dis, green, [foodx1, foody2,snake_block, snake_block]) #초록색 사각형 생성  //먹이를 생성
        #뱀 추가 코드
        snake_Head = []
